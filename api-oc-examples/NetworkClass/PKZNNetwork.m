...
+ (instancetype)shared {
    ...
    dispatch_once(&onceToken, ^{
        ...
        //Please log in to cutout.pro to view your API key
                        ...
                        failure:(nonnull void (^)(NSError * _Nonnull))failure
{
    ...
    //Set different encoding formats according to the data type returned by the interface
